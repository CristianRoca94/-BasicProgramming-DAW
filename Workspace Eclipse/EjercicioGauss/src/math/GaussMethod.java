...
public class GaussMethod {
	...
	public static void matrixConstructor(){
		...
		numberOfVariables=Integer.parseInt(JOptionPane.showInputDialog("Introduce el número de variables (mín. 3 - máx. 10): "));
	...
	public static void jordan(){
	    ...
	    JOptionPane.showMessageDialog(null,sal,"Método de Gauss",JOptionPane.ERROR_MESSAGE);
